...
- **Reference styles** — `10_reference_styles.md` + `references/style_cards.md` for “in the spirit of” artist/theme requests (loaded into the melody subagent when relevant; see `melody_skill_bundle.py`)
